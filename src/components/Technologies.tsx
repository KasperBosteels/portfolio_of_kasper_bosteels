        ...
        <Box sx={{flexDirection:{lg:"row",md:"column",xs:"column"}, alignContent:"space-between", justifyContent:"space-between", width:"fit-content", margin:"auto",display:{lg:"inline",md:"inline",xs:"none",}}}>
            <Paper elevation={5} sx={{padding:2}}>
                <Typography variant="h6">Technologieën waar ik reeds ervaring mee heb</Typography>
                    ...
                    <a title="Mike Zinner of [mariadb.org], CC BY-SA 3.0 &lt;https://creativecommons.org/licenses/by-sa/3.0&gt;, via Wikimedia Commons" href="https://commons.wikimedia.org/wiki/File:Mariadb-seal-browntext.svg"><img width="92" alt="Mariadb-seal-browntext" src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/68/Mariadb-seal-browntext.svg/64px-Mariadb-seal-browntext.svg.png"/></a>
