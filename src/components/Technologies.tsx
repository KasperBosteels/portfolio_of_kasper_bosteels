        ...
        <Box sx={{flexDirection:{lg:"row",md:"column",xs:"column"}, alignContent:"space-between", justifyContent:"space-between", width:"80%", margin:"auto",display:{lg:"inline",md:"inline",xs:"none",}}}>
            <Paper elevation={5} sx={{padding:2}}>
                <Typography variant="h6">Technologieën waar ik reeds ervaring mee heb</Typography>
                    ...
                    <a title="expressjs developers, Public domain, via Wikimedia Commons" href="https://commons.wikimedia.org/wiki/File:Expressjs.png"><img style={{backgroundColor:"red", borderRadius:"2rem",}} width="64" alt="Expressjs" src="https://upload.wikimedia.org/wikipedia/commons/6/64/Expressjs.png"/></a>
                    <a title="™/®Oracle Corporation, Public domain, via Wikimedia Commons" href="https://commons.wikimedia.org/wiki/File:MySQL_textlogo.svg"><img style={{backgroundColor:"white", borderRadius:"2rem", }} width="64" alt="MySQL textlogo" src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/0a/MySQL_textlogo.svg/64px-MySQL_textlogo.svg.png"/></a>
                    <a title="Mike Zinner of [mariadb.org], CC BY-SA 3.0 &lt;https://creativecommons.org/licenses/by-sa/3.0&gt;, via Wikimedia Commons" href="https://commons.wikimedia.org/wiki/File:Mariadb-seal-browntext.svg"><img width="64" alt="Mariadb-seal-browntext" src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/68/Mariadb-seal-browntext.svg/64px-Mariadb-seal-browntext.svg.png"/></a>
                    <a title="Typeorm logo" href="https://user-images.githubusercontent.com/30929568/112730670-de09a480-8f58-11eb-9875-0d9ebb87fbd6.png"><img style={{backgroundColor:"white", borderRadius:"2rem", }} width="64" alt="Typeorm logo" src="https://user-images.githubusercontent.com/30929568/112730670-de09a480-8f58-11eb-9875-0d9ebb87fbd6.png"/></a>
                    <a title="Alexander Sosluev, CC BY-SA 4.0 &lt;https://creativecommons.org/licenses/by-sa/4.0&gt;, via Wikimedia Commons" href="https://commons.wikimedia.org/wiki/File:Mongodb.png"><img style={{backgroundColor:"white", borderRadius:"2rem", }} width="64" alt="Mongodb" src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/00/Mongodb.png/64px-Mongodb.png"/></a>
                    <a title="UiPath.com, Public domain, via Wikimedia Commons" href="https://commons.wikimedia.org/wiki/File:UiPath_Logo.png"><img style={{padding:".3rem", backgroundColor:"white", borderRadius:"2rem",borderWidth:0 }} width="64" alt="UiPath Logo" src="https://upload.wikimedia.org/wikipedia/commons/9/96/UiPath_Logo.png"/></a>
            </Paper>
        </Box>
    )
}
